...
var mineBlock = (blockData) => {
    ...
    while (nextHash % 37 !== 0) {
        ...
        console.log("\"index\": " + nextIndex + ", \"previousHash\": " + previousBlock.hash + ", \"timestamp\": " + nextTimestamp + ", \"data\": " + blockData + ", \"hash\": " + nextHash + ", \"difficulty\": " + difficulty + ", \"nonce\": " + nonce);
    }
...
//  $env:HTTP_PORT=3002; $env:P2P_PORT=6002; $env:PEERS="ws://192.168.1.62:6001"; npm start